import {obligationsDetails, optionsDetails} from '../../data/agreement';

const agreementSelectLogic = (property: string, number: number) => {
...
export default agreementSelectLogic;
